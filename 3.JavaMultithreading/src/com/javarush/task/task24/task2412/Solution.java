	...
	public static void sort(List<Stock> list) {
		list.sort(new Comparator<Stock>() {
			public int compare(Stock stock1, Stock stock2) {
				...
				int resultDate = ((Date) stock2.get("date")).compareTo((Date) stock1.get("date"));
				...
				if (resultName != 0) {
					...
					if (resultDate != 0) {
						...
						if (stock2.get("change") == null || stock1.get("change") == null) {
							int resultChange = (int) ((int) ((double) stock2.get("change")) - ((double) stock1.get("change")));
							return resultChange;
						} else {
							return resultDate;
						}
